...
@section('inside_product')
    ...
    <script>
        $(document).ready(function() {
            $('#add_product_to_cart').click(function() {
                ...
                if (sizeSelected) {
                    var testText = document.querySelector("#test_text").innerHTML;
    ...
    <script src="{{ asset('public/frontend/js/InsightProduct.js') }}"></script>

    <?php
    if (isset($_GET['action']) && $_GET['action'] == 'giohang') {
        $conn = new mysqli('localhost', 'root', '', 'elaravel');
        ...
        $sql = "INSERT INTO tbl_product(product_id, category_id, product_name, product_desc, product_content, product_price, product_image, product_color, product_status) VALUES ('51' , '1' , 'Vòng Tay đá thạch anh đào mix charm bạc mặt trăng ngôi sao' , 'a' , 'b' , '752000' , 'main_img_1.jpg' , '1' , '1' )";
