        ...
        <div class="container-fluid"> <!-- /*CHỌN LOẠI HIỂN THỊ*/ -->
            <div class="filter-bar"> 
                ...
                <div class="category"> 
                    ...
                    <form method="POST">
                    <ul class="">
                        <li><input type="checkbox" onclick="MakeFilter()" class="checkbox_color" name="" id=""> Xanh dương</li>
                        <li><input type="checkbox" onclick="MakeFilter()" class="checkbox_color" name="" id=""> Đỏ</li>
                        <li><input type="checkbox" onclick="MakeFilter()" class="checkbox_color" name="" id=""> Vàng</li>
                        <li><input type="checkbox" onclick="MakeFilter()" class="checkbox_color" name="" id=""> Trắng</li>
                        <li><input type="checkbox" onclick="MakeFilter()" class="checkbox_color" name="" id=""> Đen</li>
